...
public class Player1 : MonoBehaviour
{
    ...
    public string condition = "startCell";
    ...
    public void OnClick(GameObject cell, int indexOfCell)
    {
        if (cell.GetComponent<callBild>().conditionPlayerWalk == "Yes")
        {
            ...
            {
                player.transform.position = new Vector3(cell.transform.position.x, cell.transform.position.y, cell.transform.position.z);
    ...
    private void FixedUpdate()
    {
        ...
        if (cn)
        {
            ...
            if (condition == "startCell")
            {
                if (condition_.Contains(indexPlayer))
                {
                    allCells[9].GetComponent<callBild>().conditionPlayerWalk = "Yes";
                }
            }
            else
            {
